...
> 예제: [jdbc-default-authentication](jdbc-default-authentication)
> 보충 예제: [jdbc-custom-table-authentication](jdbc-custom-table-authentication)
>
> * 커스텀 유저/권한 테이블을 사용한 예제



### 5.3.4 기법: 커스텀 UserDetailsService 적용

> 예제: [jdbc-custom-table-authentication-userdetailsservice](jdbc-custom-table-authentication-userdetailsservice)
> 
...
> 예제: [ldap-authentication](ldap-authentication)
> 



### 5.3.6 기법: HTTP 기본 인증 적용

> 예제: [http-basic-authentication](http-basic-authentication)
> 
...
#### ROLE_ADMIN 권한 전용 페이지 작성 예제

> 예제: [understanding-roles](understanding-roles)
...
일단은... 예전에 "스프링 시큐리티 인 액션" 책 봤던 기억이 조금씩 떠오르고 있다. 😅
